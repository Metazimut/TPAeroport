...
public class ClientRepositoryJpa implements IClientRepository {
	...
	public List<Client> findAll() {
		...
		try {
			...
			TypedQuery<Client> query = em.createQuery("select c from Client p", Client.class);
	...
	public List<Particulier> findAllParticulier() {
		...
		try {
			...
			TypedQuery<Particulier> query = em.createQuery("select s from Particulier s", Particulier.class);
	...
	@Override
	public List<Entreprise> findAllEntrerpise() {
		List<Entreprise> entrerpises = new ArrayList<Entreprise>();
		...
		try {
			...
			TypedQuery<Entreprise> query = em.createQuery("select f from Entrerpise f", Entreprise.class);

			entrerpises = query.getResultList();
